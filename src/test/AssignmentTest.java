...
public class AssignmentTest {
    ...
    public void testConstructorWithValidParameters() {
        ...
        assertEquals("Group should match", "Module1", assignment.getGroup());
    ...
    public void testConstructorWithEmptyName() {
        new Assignment("", 100.0, "2023-10-15", "Quizzes", null);
    }
    ...
    public void testConstructorWithZeroPoints() {
        new Assignment("Math Quiz", 0.0, "2023-10-15", "Quizzes", null);
    }
    ...
    public void testConstructorWithNullCategory() {
        new Assignment("Math Quiz", 100.0, "2023-10-15", null, null);
    }
